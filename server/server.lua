...
QBCore.Functions.CreateUseableItem('donut1', function(source, item)
    TriggerClientEvent('nk-burgershot:client:eat', source, item.name, 'Eating Donut!!...', math.random(5000, 10000), math.random(30, 40), 0, 'donut')
end)
QBCore.Functions.CreateUseableItem('donut2', function(source, item)
    TriggerClientEvent('nk-burgershot:client:eat', source, item.name, 'Eating Strawberry Donut!!...', math.random(5000, 10000), math.random(35, 45), 0, 'donut3')
end)
QBCore.Functions.CreateUseableItem('donut3', function(source, item)
    TriggerClientEvent('nk-burgershot:client:eat', source, item.name, 'Eating Shocolate Donut!!...', math.random(5000, 10000), math.random(40, 50), 0, 'donut2')
end)
--add more food iteam 
...
QBCore.Functions.CreateUseableItem('small_softdrink', function(source, item)
    TriggerClientEvent('nk-burgershot:client:drink', source, item.name, 'Drinking Wine', math.random(5000, 10000), 0, math.random(40, 60), 'cup')
end)
QBCore.Functions.CreateUseableItem('big_softdrink', function(source, item)
    TriggerClientEvent('nk-burgershot:client:drink', source, item.name, 'Drinking Wine', math.random(5000, 10000), 0, math.random(40, 60), 'soda4')
end)
QBCore.Functions.CreateUseableItem('milkshake', function(source, item)
    TriggerClientEvent('nk-burgershot:client:drink', source, item.name, 'Drinking Wine', math.random(5000, 10000), 0, math.random(40, 60), 'sipshake')
end)
